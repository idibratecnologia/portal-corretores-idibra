...
import { ArrowLeft, Mail, Phone, MessageCircle, Instagram, MapPin, Building2, Calendar, CheckCircle, XCircle, Clock } from 'lucide-react'
  ...
  if (!corretor) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button onClick={() => navigate('/admin/corretores')} variant="outline">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Button onClick={() => navigate('/admin/corretores')} variant="outline" size="sm">
          <ArrowLeft className="w-4 h-4 mr-2" /> Voltar
        </Button>
