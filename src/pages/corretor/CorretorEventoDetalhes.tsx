...
import { ArrowLeft, Calendar, Clock, MapPin, Users, ExternalLink, QrCode, X } from 'lucide-react'
...
export function CorretorEventoDetalhes() {
  ...
  if (!evento) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button onClick={() => navigate('/portal/eventos')} variant="outline">
  ...
  return (
    <div className="space-y-6">
      <Button onClick={() => navigate('/portal/eventos')} variant="outline" size="sm">
        <ArrowLeft className="w-4 h-4 mr-2" /> Voltar aos eventos
      </Button>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">{evento.total_inscritos ?? 0}/{evento.capacidade} inscritos</p>
                </div>
              </div>
            </div>
